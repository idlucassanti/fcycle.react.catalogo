...
export const initialState = [
  ...
  {...category, id: "5", name: "Dyovana Santi 5", is_active: true, create_at: "1995-12-17T03:24:00"},
  {...category, id: "6", name: "Matteo Santi 6", is_active: true, create_at: "1995-12-17T03:24:00"},
];
...
export function selectCategoryById(state: RootState, id: string) {
